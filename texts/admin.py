...
BROADCAST_ASK_TEXT = "📢 <b>Розсилка</b>\n\nНапишіть текст повідомлення:"
BROADCAST_PREVIEW = "📢 <b>Прев'ю:</b>\n\n———\n{text}\n———\n\nОберіть дію:"
BROADCAST_NOW_BTN = "⚡️ Надіслати зараз"
BROADCAST_SCHEDULE_BTN = "🕒 Запланувати на час"
BROADCAST_CANCEL_BTN = "❌ Скасувати"
BROADCAST_ASK_TIME = "Вкажіть час відправки (HH:MM за Києвом):"
BROADCAST_SCHEDULED = "✅ Заплановано на <b>{time}</b> (Київ). Отримають усі гості."
BROADCAST_SENT = "✅ Надіслано <b>{count}</b> гостям."
BROADCAST_BAD_TIME = "Невірний формат. Введіть час у форматі <b>HH:MM</b>, наприклад 09:30:"
BROADCAST_TIME_PAST = "Цей час вже минув. Введіть майбутній час:"
MORNING_MSG_TEXT = (
    "Доброго ранку!\n\n"
...
CONSULT_LIST_BTN = "Консультації Анни Барінової"
...
CONSULT_PARTICIPANTS_HEADER = "<b>Консультації Анни Барінової</b>\nЗаписано слотів: {count} з {total}\n"
